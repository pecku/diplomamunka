...
\hline
\texttt{funar} & A függvény szimbólumok halmaza aritás szerint \\
\hline
\texttt{relar} & A relációs szimbólumok halmaza aritás szerint \\
\hline
\texttt{D} & Az alap halmaz (a modell tartománya) \\
\hline
\texttt{fun} & A függvény szimbólumok értelmezése (szemantikai jelentés) \\ \hline
\texttt{Rel} & A relációs szimbólumok értelmezése (szemantikai jelentés) \\
\hline
\end{tabular}
...
\texttt{D} & Az alap halmaz (a modell tartománya) \\
\hline
\texttt{fun} & A függvény szimbólumok értelmezése (szemantikai jelentés) \\
\hline
\texttt{Rel} & A relációs szimbólumok értelmezése (szemantikai jelentés) \\
\hline
\end{tabular}
...
\item A logikai operátorok szemantikája hasonlóan van definiálva, de a modell szerkezete egyszerűbb és célorientáltabb.
\end{itemize}
...
Minden predikátum egy típuscsalád, amely a domain elemeihez típusokat rendel. A logikai konnektívák típuskonstruktorokként lesznek implementálva (pl. függő összeg és szorzat típusok). A kvantorok függő típusokként jelennek meg (Π és Σ típusok). A bizonyítások a megfelelő típusok értékei.
