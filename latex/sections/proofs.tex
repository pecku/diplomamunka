...
\input{sections/agda/latex/Peano.tex}
    ...
    \infer[∀in]{∀x(P(x) ∧ Q(x)) \vdash ∀x\,P(x)}{
      \infer[∧out₁]{∀ x(P(x) ∧ Q(x)) \vdash P(x)}{
        \infer[∀out]{∀ x(P(x) ∧ Q(x)) \vdash P(x) ∧ Q(x)}{
            ∀x(P(x) ∧ Q(x)) \vdash ∀x(P(x) ∧ Q(x) \quad \text{\small [Ax]}
        }
      }
    }
    &
